...
const EmployeeConfig = () => {
  ...
  console.log("transportWays", transportWays)
  ...
  const fetchEmp = async (id) => {
    try {
      ...
      if (res.data.status) {
        ...
        console.log(res.data.result.transportWays)
    ...
    <div className="container">
      ...
      <div className="config_tab">
        <div
          ...
          className={`confi_div ${activeTab === "Role" ? "config_active_tab" : ""}`}
        >
          Role Hierarchy
        </div>
        <div
          onClick={() => setactiveTab("Device")}
          className={`confi_div ${activeTab === "Device" ? "config_active_tab" : ""}`}
        >
          Device config
        </div>
        <div
          onClick={() => setactiveTab("Salary")}
          className={`confi_div ${activeTab === "Salary" ? "config_active_tab" : ""}`}
        >
          Salary
        </div>
        <div
          onClick={() => setactiveTab("User")}
          className={`confi_div ${activeTab === "User" ? "config_active_tab" : ""}`}
        >
          User Expensive
        </div>
        <div
          onClick={() => setresetAllDevicePopup(true)}
          className={`confi_div config_active_tab`}
        >
          {resetBtnLoading ? (
              ...
              <div className="addbeat_container">
                ...
                <div className="addbeat_form">
                  <div className="addbeat_left">
                    ...
                    {/* <label>Salary (Basic + HRA + Convyence)</label>
                    <input
                      type="number"
                      name="salaryAll"
                      value={userExpenses.salaryAll}
                      onChange={handleInputUC}
                      placeholder="Salary (Basic + HRA + Convyence)"
                    />
                    <label>Salary (Convyence)</label>
                    <input
                      type="number"
                      name="salaryConvyence"
                      value={userExpenses.salaryConvyence}
                      onChange={handleInputUC}
                      placeholder="Salary (Convyence)"
                    /> */}
                  ...
                  <div className="addbeat_right">
                    ...
                    {/* <label>Salary (HRA)</label>
                    <input
                      type="number"
                      name="salaryHRA"
                      value={transportWays.salaryHRA}
                      onChange={handleInputTW}
                      placeholder="Salary (HRA)"
                    /> */}
