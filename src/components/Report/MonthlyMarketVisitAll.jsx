...
const MonthlyMarketVisitAll = () => {
    ...
    const getMMarketVisitFunc = async (filterData) => {
        ...
        if (res.data.status) {
            ...
            setreportSummery(res.data.result.summary)
    ...
    const filterAndExportFunc = (type) => {
        ...
        if (type === "column_filter") return setfilterDivExtended(!filterDivExtended);
            ...
            return saveToPdf(pdfView, "Monthly Market Visit Report (All Employee)");
        }
    }
        ...
        <div className="container">
            <div className="beat_heading">
                <div className="beat_left">
                    ...
                    <div className="title">Monthly Market Visit Report (All Employee)</div>
                </div>
            ...
            {isLoading ? (
                ...
                <div className="">
                    ...
                    {reportSummery && mMarketVisitReport?.length !== 0 && (
                            ...
                            <div className="report_summery_body">
                                <div className="report_summery_left">
                                    <div className="summery_column">
                                        <div className="detail_title">Total TC:</div>
                                        <div className="detail">{reportSummery.total_tc}</div>
                                    </div>
                                    <div className="summery_column">
                                        <div className="detail_title">Total NC:</div>
                                        <div className="detail">{reportSummery.total_nc}</div>
                                    </div>
                                    <div className="summery_column">
                                        <div className="detail_title">Total AC:</div>
                                        <div className="detail">{reportSummery.total_ac}</div>
                                    </div>
                                    <div className="summery_column">
                                        <div className="detail_title">Total Amount:</div>
                                        <div className="detail">₹{reportSummery.total_sales}</div>
                                    </div>
                                </div>
                                <div className="report_summery_right">
                                    <div className="summery_column">
                                        <div className="detail_title">Total PC:</div>
                                        <div className="detail">₹{reportSummery.total_pc}</div>
                                    </div>
                                    <div className="summery_column">
                                        <div className="detail_title">Total TBC:</div>
                                        <div className="detail">{reportSummery.total_tbc}</div>
                                    </div>
                                    <div className="summery_column">
                                        <div className="detail_title">Total UC:</div>
                                        <div className="detail">{reportSummery.total_uc}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="hide_pdf_container" ref={pdfView}>
                <div className="pdf_head_section">
                    <div className="pdf_head_left">
                        ...
                        <div className="pdf_selected_date">Monthly Market Visit Report (All Employee) ({reportSummery?.pdf_start_date || "NA"} - {reportSummery?.pdf_end_date || "NA"})</div>
                    </div>
                ...
                <Table sx={{ minWidth: 700 }} aria-label="customized table">
                    ...
                    <TableBody>
                        ...
                        <PDFStyledTableRow >
                            ...
                            {tableCols[1]?.active && <PDFStyledTableCell style={{ fontSize: "1.2rem", fontWeight: "bold" }}>{reportSummery?.pdf_total_days}</PDFStyledTableCell>}
                            {tableCols[2]?.active && <PDFStyledTableCell style={{ fontSize: "1.2rem", fontWeight: "bold" }}>{reportSummery?.pdf_total_tc}</PDFStyledTableCell>}
                            {tableCols[3]?.active && <PDFStyledTableCell style={{ fontSize: "1.2rem", fontWeight: "bold" }}>{reportSummery?.pdf_total_pc}</PDFStyledTableCell>}
                            {tableCols[4]?.active && <PDFStyledTableCell style={{ fontSize: "1.2rem", fontWeight: "bold" }}>{reportSummery?.pdf_total_mc}</PDFStyledTableCell>}
                            {tableCols[5]?.active && <PDFStyledTableCell style={{ fontSize: "1.2rem", fontWeight: "bold" }}>{reportSummery?.pdf_total_tbc}</PDFStyledTableCell>}
                            {tableCols[6]?.active && <PDFStyledTableCell style={{ fontSize: "1.2rem", fontWeight: "bold" }}>{reportSummery?.pdf_total_ac}</PDFStyledTableCell>}
                            {tableCols[7]?.active && <PDFStyledTableCell style={{ fontSize: "1.2rem", fontWeight: "bold" }}>{reportSummery?.pdf_total_uc}</PDFStyledTableCell>}
                            {tableCols[8]?.active && <PDFStyledTableCell style={{ fontSize: "1.2rem", fontWeight: "bold" }}>{reportSummery?.pdf_total_sales}</PDFStyledTableCell>}
                        </PDFStyledTableRow>
                    </TableBody>
                </Table>
...
export default MonthlyMarketVisitAll;
