  ...
  return (
    <div className="container">
      ...
      <div className="lead_tab_container" style={{ margin: '1rem 0 2rem 0' }}>
        <div onClick={() => setactiveTab('Customers')} className={`${activeTab === 'Customers' ? 'lead_tab active_tab' : 'lead_tab'}`}>
          Customers
        </div>
        <div onClick={() => setactiveTab('Leads')} className={`${activeTab === 'Leads' ? 'lead_tab active_tab' : 'lead_tab'}`}>
          Leads
        </div>
        <div onClick={() => setactiveTab('Group')} className={`${activeTab === 'Group' ? 'lead_tab active_tab' : 'lead_tab'}`}>
          Group
        </div>
        <div onClick={() => setactiveTab('Teams')} className={`${activeTab === 'Teams' ? 'lead_tab active_tab' : 'lead_tab'}`}>
          Teams
        </div>
      </div>
