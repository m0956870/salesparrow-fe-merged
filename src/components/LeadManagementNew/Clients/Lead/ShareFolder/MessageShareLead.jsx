...
import SendMessagePage from '../../../Content/Message/ShareMessageList/SendMessagePage';
import SendLeadMessagePage from './SendLeadsMessage';

const MessageShareLead = () => {
...
export default MessageShareLead