                ...
                <div className="center_invoice">
                    <div id="invoice" style={{ padding: "1.5rem" }}>
                        <div className="invoice_detail_heading">
                            <span className="invoice_id">Primary Order Details</span>
                        </div>
                        <div style={{ display: "flex" }} >
                            <div className="invoice_party_detail" style={{ paddingTop: "1rem", flex: 1 }}>
                                ...
                                <div>City : <span className="grey_span">{invoiceData?.city}</span></div>
                                <div>State : <span className="grey_span">{invoiceData?.state}</span></div>
                            </div>
                            <div className="invoice_party_detail" style={{ paddingTop: "1rem", flex: 1 }}>
                                <div>Order Date : <span className="grey_span">{invoiceData?.date}</span></div>
                                <div>Order Amount : <span className="grey_span">₹{invoiceData?.amount}</span></div>
