...
const EmployeeDistributerGroupDialog = (props) => {
        ...
        <div>
            ...
            >
                <DialogTitle className="dialog_title">
                    {props.dialogData === undefined ? "Employee & Beat Mapping" : "Edit Employee & Beat Mapping"}
                </DialogTitle>
                        ...
                        <div className="message_left">
                            <div className="message_form">
                                <div className="dual_select">
                                    <select name="city">
                                        <option value="City">
                                            {props.dialogData === undefined ? "State (Employee) " : `${props.dialogData.employee}`}
                                        </option>
                                ...
                                <div className="dual_select">
                                    <select name="city">
                                        <option value="City">
                                            {props.dialogData === undefined ? "State (Dealer) " : `${props.dialogData.employee}`}
                                        </option>
                                        <option value="saab">Saab</option>
                                        <option value="mercedes">Mercedes</option>
                                        <option value="audi">Audi</option>
                        ...
                        <div className="message_right">
                            <div className="message_form">
                                <div className="dual_select">
                                    <select name="city" >
                                        <option value="City">
                                            {props.dialogData === undefined ? "Employee" : `${props.dialogData.distributor}`}
                                        </option>
                                        <option value="saab">Saab</option>
                                        <option value="mercedes">Mercedes</option>
                                        <option value="audi">Audi</option>
                                ...
                                <div className="dual_select">
                                    <select name="city">
                                        <option value="City">
                                            {props.dialogData === undefined ? "Dealer" : `${props.dialogData.distributor}`}
                                        </option>
                                        <option value="saab">Saab</option>
                                        <option value="mercedes">Mercedes</option>
                                        <option value="audi">Audi</option>
...
export default EmployeeDistributerGroupDialog;
