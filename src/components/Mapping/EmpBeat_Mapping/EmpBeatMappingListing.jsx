...
import AddEmployeeBeatDialog from './AddEmpBeatDialog';


const EmpBeatMappingListing = () => {
    ...
    // useEffect(() => {
    //     if (addDialogBox === false) getEmpPriceListFunc()
    // }, [addDialogBox])

    // useEffect(() => {
    //     if (editDialogBox === false) getEmpPriceListFunc()
    // }, [editDialogBox])

    async function getEmpPriceListFunc() {
        // setisLoading(true)

        // let { data } = await getEmpPriceList(pageCount)
        // if (data.status) {
        //     setempPriceList(data.result)
    ...
    const deleteEmpGrpProductGrpFunc = async () => {
        ...
        // setisLoading(true)
        // let { data } = await deleteEmpPriceList(editDialogBoxData.emp_id)
        // if (data.status) {
        ...
        <div className="container">
            <div className="beat_heading">
                <div className="beat_left" >
                    ...
                    <div className="title">Employee / Beat Mapping List</div>
                </div>
                    ...
                    <Table sx={{ minWidth: 700 }} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="center">Assigned Beat Name</StyledTableCell>
...
export default EmpBeatMappingListing